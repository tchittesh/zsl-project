...
def main(args):
	...
	norm_info = train_dataset.norm_info is hasattr(train_dataset, 'norm_info') else None
	...
	model = SJE_Original(train_dataset.get_img_feature_size(), train_dataset.get_num_attributes(), margin=args.margin)
